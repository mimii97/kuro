...
<div class="card card-dark">
	...
	<div class="card-body">
		<div class="row">
			...
			@if(!empty($blogs->admin_id()->first()))
			<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
				<b>{{trans('admin.admin_id')}} :</b>
				{{ $blogs->admin_id()->first()->name }}
			</div>
			@endif
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.num_comments')}} :</b>
				{!! $blogs->comments()->count('id') !!}
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.num_likes')}} :</b>
				{!! $blogs->likes()->count('like') !!}
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.num_dislikes')}} :</b>
				{!! $blogs->dislikes()->count('dislike') !!}
			</div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<b>{{trans('admin.body')}} :</b>
				{!! $blogs->body !!}
			</div>
